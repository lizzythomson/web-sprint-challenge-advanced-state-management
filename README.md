...
Context API solves the problem of passing props through multiple components(prop drilling) and is a simpler setup than Redux if you don't have a complex app that is concerned about scalability.

2. In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?

Action: tells the reducer how to change state. Actions contain information (which will always have a type field).

Reducers: A reducer is a function that takes in the previous state and an action and returns the next new state. Reducers are triggered by actions.

Store: is a state container which is an unchangable (or immutable) object. Redux can only have a single store in the app causing it to be known as a "single source of truth".

3. What does `redux-thunk` allow us to do? How does it change our `action-creators`?

Action-creators are only able to return an object; whereas, redux-thunk allows you to return a function.

4. What is your favorite state management system you've learned and this sprint? Please explain why!

Although I think it will take more practice to master, I like redux. I feel like there is a lot of setup, but being able to understand the concepts and fix issues that arise will help me stand out in industry (even being able to know when to not use redux). Also I feel like if you understand redux and what problem it solves it makes prop drilling and context API simpler to understand and use.
